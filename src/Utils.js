...
export const quarter_abbreviations = {
	Fall: 'FA',
	Winter: 'WI',
	Spring: 'SP',
	'Summer Med School': 'SU',
	'Summer Session 1': 'S1',
	'Summer Session 2': 'S2',
	'Summer Session 3': 'S3',
	Summer: 'SA'
...
export const quarter_expansions = {
	FA: 'Fall',
	WI: 'Winter',
	SP: 'Spring',
...
export const naturalSort = (a, b) => {
	...
	a['code'].replace(/(\d+)|(\D+)/g, function(_, $1, $2) {
		ax.push([ $1 || Infinity, $2 || '' ]);
	});
	b['code'].replace(/(\d+)|(\D+)/g, function(_, $1, $2) {
